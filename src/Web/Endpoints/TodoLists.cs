using MarmindSample.Application.TodoLists.Commands.CreateTodoList;
using MarmindSample.Application.TodoLists.Commands.DeleteTodoList;
using MarmindSample.Application.TodoLists.Commands.UpdateTodoList;
using MarmindSample.Application.TodoLists.Queries.GetTodos;
...
public class TodoLists : EndpointGroupBase
{
    ...
    {
        app.MapGroup("api/todo-lists").WithTags("TodoLists")
